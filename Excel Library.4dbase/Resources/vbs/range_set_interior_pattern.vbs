...
thePattern				= CLng(GETENV("XCEL_INTERIOR_PATTERN"))
thePatternColor				= CLng(GETENV("XCEL_INTERIOR_PATTERN_COLOR"))

theRange.Interior.Pattern 	= thePattern
theRange.Interior.PatternColorIndex  	= thePatternColor