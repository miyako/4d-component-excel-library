...
Set theChart			= theSheet.ChartObjects(GETENV("XCEL_CHART_NAME"))
theAppearance		= GETENV("XCEL_PICTURE_APPEARANCE")
theFormat			= GETENV("XCEL_PICTURE_FORMAT")

theChart.CopyPicture theAppearance, theFormat
