...
theDisplayHorizontalScrollBarProperty		= GETENV("XCEL_WINDOW_DISPLAY_HORIZONTAL_SCROLL_BAR")

theWindow.DisplayHorizontalScrollBar		= theDisplayHorizontalScrollBarProperty
