...
Set thePageSetup		= theSheet.PageSetup

theFooterMargin			= objExcelApplication.CentimetersToPoints(CDbl(GETENV("XCEL_PAGE_SETUP_FOOTER_MARGIN")))

thePageSetup.FooterMargin 		= theFooterMargin
